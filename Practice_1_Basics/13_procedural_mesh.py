...
from panda3d.core import OrthographicLens, GeomVertexFormat, GeomVertexData, TransparencyAttrib
...
class GameWindow(ShowBase):
    def __init__(self):
        ...
        square2 = create_colored_rect(350, 100, 200, 200, (0, 0, 1, 1)) # Blue
        square3 = create_colored_rect(-640, -360, 200, 200, (0, 1, 0, 1)) # Green
        ...
        textured_rect = create_textured_rect(-320, 0, 400, 280) 
        gnode2.addGeom(textured_rect)

        texture = self.loader.loadTexture("assets/pictures/Tulo chad alpha.png")
